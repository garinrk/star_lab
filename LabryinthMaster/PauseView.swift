...
class PauseView : UIView{
    ...
    override func drawRect(rect: CGRect) {
        ...
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-80-[quit]-[musicImage]-[fximage]-[currentScoreImage]-[currentScore]-|", options: NSLayoutFormatOptions(), metrics: nil, views: views))
